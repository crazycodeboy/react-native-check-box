...
checkBoxColor | PropTypes.string | true |   | Tint color of the checkbox image (this is for both checked and unchecked state)
checkedCheckBoxColor | PropTypes.string | true |   | Tint color of the checked state checkbox image (note this will override value of `checkBoxColor` for checked state)
uncheckedCheckBoxColor | PropTypes.string | true |   | Tint color of the unchecked state checkbox image (note this will override value of `checkBoxColor` for unchecked state)
